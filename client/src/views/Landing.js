    ...
    <LandingPageContainer>
      ...
      <FeaturesInfo>
        <InfoBox>
          <h3>Work Easier</h3>
          <p>
            Finding a place to work away form the home or office doesn't need to
            be a hassle. Find locations that meet your needs no matter where you
            are!
          </p>
        ...
        <FeatureBox>
          ...
          <p>
            Whether you're traveling or looking to get out of the house in your
        ...
        <FeatureBox>
          ...
          <h3>Get Info</h3>
          <p>
            Find the location's available hours, address, phone number, and
            more.
          </p>
        </FeatureBox>
        <FeatureBox>
          ...
          <p>
            Read reviews from remote workers like you! Read about the speed and
            reliability of the internet, the noise level, and other important
            factors.
          </p>
        </FeatureBox>
      </FeaturesInfo>
      <MockupContainer>
        ...
        <LargeMarketing>
          ...
          <p>
            Whether you're looking for some free wifi to work while you're
            traveling or you're just wanting to get away from the house or
            office for a change of scenery, The HiveStack is built to help you
            find the best place to work.
          </p>
          <Bullets>
            <div>
              <i class="fa fa-coffee fa-2x"></i>
              <p>Find coffee shops and cafes</p>
            </div>
            <div>
              <i class="fas fa-wifi fa-2x"></i>
              <p>Check wifi speeds and reliability</p>
            </div>
            <div>
              <i class="fas fa-laptop fa-2x"></i>
              <p>Sit down and get some work done</p>
            </div>
          </Bullets>
        </LargeMarketing>
      </MockupContainer>
